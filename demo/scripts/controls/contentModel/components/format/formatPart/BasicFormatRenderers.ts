...
export const SuperOrSubScriptFormatRenderers: FormatRenderer<SuperOrSubScriptFormat>[] = [
    createCheckboxFormatRenderer<SuperOrSubScriptFormat>(
        'Superscript',
        format => format.superscript,
        (format, value) => (format.superscript = value)
    ),
    createCheckboxFormatRenderer<SuperOrSubScriptFormat>(
        'Subscript',
        format => format.subscript,
        (format, value) => (format.subscript = value)
    ),
];
